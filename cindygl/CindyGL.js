...
var type = {bool:1, int:2, float:3, complex:4, voidt:5, color:6, point:7, line:8, coordinate2d:9, image:10, vec2:list(2, 3), vec3:list(3, 3), vec4:list(4, 3), vec:function(n) {
  ...
  return list(n, 4);
}, mat2:list(2, list(2, 3)), mat3:list(3, list(3, 3)), mat4:list(4, list(4, 3)), anytype:18};
Object.freeze(type);
...
webgl["min"] = function(args) {
  var match = first([[[type.int, type.int], type.int, usefunction("min")], [[type.float, type.float], type.float, usefunction("min")]])(args);
  if (match) {
    return match;
  }
...
webgl["pow"] = first([[[type.float, type.int], type.float, useincludefunction("powi")], [[type.complex, type.complex], type.complex, useincludefunction("powc")]]);
webgl["^"] = webgl["pow"];
